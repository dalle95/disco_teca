...
class DettaglioDiscoLoadingState extends DettaglioDiscoState {
  DettaglioDiscoLoadingState()
      : super(
          ...
          annoController: TextEditingController(text: "Loading..."),
          valoreController: TextEditingController(text: "Loading..."),
          brano1AController: TextEditingController(text: "Loading..."),
          brano2AController: TextEditingController(text: "Loading..."),
          brano3AController: TextEditingController(text: "Loading..."),
          brano4AController: TextEditingController(text: "Loading..."),
          brano5AController: TextEditingController(text: "Loading..."),
          brano6AController: TextEditingController(text: "Loading..."),
          brano7AController: TextEditingController(text: "Loading..."),
          brano8AController: TextEditingController(text: "Loading..."),
          brano1BController: TextEditingController(text: "Loading..."),
          brano2BController: TextEditingController(text: "Loading..."),
          brano3BController: TextEditingController(text: "Loading..."),
          brano4BController: TextEditingController(text: "Loading..."),
          brano5BController: TextEditingController(text: "Loading..."),
          brano6BController: TextEditingController(text: "Loading..."),
          brano7BController: TextEditingController(text: "Loading..."),
